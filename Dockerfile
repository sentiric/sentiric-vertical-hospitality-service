...
RUN CGO_ENABLED=0 GOOS=linux go build \
    ...
    -o /app/bin/sentiric-vertical-hospitality-service ./cmd/vertical-hospitality-service
...
COPY --from=builder /app/bin/sentiric-vertical-hospitality-service .
RUN chown appuser:appgroup ./sentiric-vertical-hospitality-service

# GÜVENLİK: Kullanıcıyı değiştir
USER appuser

ENTRYPOINT ["./sentiric-vertical-hospitality-service"]